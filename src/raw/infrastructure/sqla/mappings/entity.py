...
entities_table = Table(
    ...
    Column("parent_id", Integer, ForeignKey("entities.id", ondelete="CASCADE"), nullable=True),
...
entity_refs_table = Table(
    ...
    Column("ref_id", Integer, ForeignKey("entities.id", ondelete="CASCADE"), primary_key=True),
)
